...
func (rm *resourceManager) sdkFind(
	...
	if resp.PreparedStatement.Description != nil {
		ko.Spec.Description = resp.PreparedStatement.Description
	} else {
		ko.Spec.Description = nil
	}
	if resp.PreparedStatement.QueryStatement != nil {
		ko.Spec.QueryStatement = resp.PreparedStatement.QueryStatement
	} else {
		ko.Spec.QueryStatement = nil
	}
	if resp.PreparedStatement.StatementName != nil {
		ko.Spec.Name = resp.PreparedStatement.StatementName
	} else {
		ko.Spec.Name = nil
	}
...
func (rm *resourceManager) requiredFieldsMissingFromReadOneInput(
	...
	return r.ko.Spec.Name == nil || r.ko.Spec.WorkGroup == nil
...
func (rm *resourceManager) newDescribeRequestPayload(
	r *resource,
) (*svcsdk.GetPreparedStatementInput, error) {
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.CreatePreparedStatementInput, error) {
...
func (rm *resourceManager) newUpdateRequestPayload(
	...
	r *resource,
	delta *ackcompare.Delta,
) (*svcsdk.UpdatePreparedStatementInput, error) {
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeletePreparedStatementInput, error) {
