...
const (
	finalizerString = "finalizers.athena.services.k8s.aws/PreparedStatement"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("preparedstatements")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.PreparedStatement{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PreparedStatement),
	}
}
