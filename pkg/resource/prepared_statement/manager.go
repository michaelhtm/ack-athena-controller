...
// +kubebuilder:rbac:groups=athena.services.k8s.aws,resources=preparedstatements,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=athena.services.k8s.aws,resources=preparedstatements/status,verbs=get;update;patch
