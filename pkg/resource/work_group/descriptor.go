...
const (
	finalizerString = "finalizers.athena.services.k8s.aws/WorkGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("workgroups")
