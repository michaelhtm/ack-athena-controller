...
// +kubebuilder:rbac:groups=athena.services.k8s.aws,resources=workgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=athena.services.k8s.aws,resources=workgroups/status,verbs=get;update;patch
